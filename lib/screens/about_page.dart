                ...
                leading: Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: NetworkImage(
                        'https://avatars.githubusercontent.com/u/152673133?v=4',
                      ),
                    ),
                  ),
                ),
                ...
                trailing: Wrap(
                  children: <Widget>[
                    IconButton(
                      ...
                      tooltip: 'Github',
                      onPressed: () {
                        launchURL(Uri.parse('https://github.com/KarthikeyanS2006'));
                      },
                    ),
                    IconButton(
                      ...
                      tooltip: 'Website',
                      onPressed: () {
                        launchURL(Uri.parse('https://KarthikeyanS2006.github.io'));
                      },
                    ),
                  ],
                ),
